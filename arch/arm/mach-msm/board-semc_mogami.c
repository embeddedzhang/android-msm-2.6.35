...
static int __init pmem_adsp_cached_size_setup(char *p)
{
	pmem_adsp_cached_size = memparse(p, NULL);
	return 0;
}
early_param("pmem_adsp_cached_size", pmem_adsp_cached_size_setup);
